        ...
        protected override void Up(MigrationBuilder migrationBuilder)
        {
            ...
            migrationBuilder.CreateTable(
                ...
                columns: table => new
                {
                    ...
                    IncidentId = table.Column<string>(type: "nvarchar(20)", maxLength: 20, nullable: false, defaultValueSql: "'INC' + CONVERT(varchar(20), NEXT VALUE FOR IncidentNumberSequence)"),
                    ...
                    RootCauseCategory = table.Column<string>(type: "nvarchar(max)", nullable: true),
                ...
                constraints: table =>
                {
                    ...
                    table.UniqueConstraint("AK_Tickets_IncidentId", x => x.IncidentId);
                });
